...
url = "postgres://bob:password@example:5432/db_one"

#inject parser to each test, 
#basically replaces following line from each test
...
def test_parser_without_driver(parser):
    ...
    '''
    #if somebody passes only url then we should go out with system exit error
